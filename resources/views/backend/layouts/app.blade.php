				...
				<div class="py-4 bg-white footer d-flex flex-lg-column" id="kt_footer">
					...
					<div class="container text-center">
						...
						<div class="order-2 text-dark order-md-1">
							...
							<a href="http://wezapps.com.bd" target="_blank"
								class="text-dark-75 text-hover-primary">{{translate('Wezapps Limited')}}</a> <span class="mr-2 text-muted font-weight-bold">{{translate('v')}}{{ get_setting('current_version') }}</span>
						</div>
